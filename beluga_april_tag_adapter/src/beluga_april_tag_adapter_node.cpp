...
BelugaAprilTagAdapterNode::BelugaAprilTagAdapterNode(const rclcpp::NodeOptions& options)
  ...
  tag_subscriber_ = this->create_subscription<apriltag_msgs::msg::AprilTagDetectionArray>(
  ...
  marker_republisher_ =
      this->create_publisher<visualization_msgs::msg::MarkerArray>("feature_markers", rclcpp::SystemDefaultsQoS());
}

void BelugaAprilTagAdapterNode::tagDetectionsCallback(const apriltag_msgs::msg::AprilTagDetectionArray::SharedPtr det) {
...
RCLCPP_COMPONENTS_REGISTER_NODE(beluga_april_tag_adapter::BelugaAprilTagAdapterNode)
