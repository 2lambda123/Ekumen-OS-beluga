...
class BelugaAprilTagAdapterNode : public rclcpp::Node {
 public:
   ...
   */
  explicit BelugaAprilTagAdapterNode(const rclcpp::NodeOptions& options = rclcpp::NodeOptions());
 ...
 private:
  ...
  void republishAsFeatures(const apriltag_msgs::msg::AprilTagDetectionArray::SharedPtr msg);
  void republishAsMarkers(const apriltag_msgs::msg::AprilTagDetectionArray::SharedPtr det);
};
