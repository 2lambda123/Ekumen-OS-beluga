...
class YamlFeatureMapLoader : public FeatureMapLoaderInterface {
 public:
   ...
   * @param map_file Path to the yaml file that contains the feature map description.
   */
   ...
   */
  std::optional<beluga_feature_map_server_msgs::msg::DiscreteFeatureMap> loadMap() override;
