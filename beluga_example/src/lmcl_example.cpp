...
using LandmarkBasedMonteCarloLocalizationInterface2d = beluga::mixin::compose_interfaces<
    ...
    beluga::LandmarkSensorModelInterface2d<beluga::LandmarkMap>>;
...
using LandmarkBasedMonteCarloLocalizationFilter = ciabatta::mixin<
    ...
    ciabatta::curry<beluga::LandmarkSensorModel, beluga::LandmarkMap>::mixin,
    ...
    if (force_update_ || moved_enough) {
      ...
      for (size_t i = 0; i < features->positions.size(); ++i) {
        ...
        measurement.emplace_back(
            feature_position_in_base_frame.x(), feature_position_in_base_frame.y(), features->categories[i]);
      }
